...
/* Fenetre generale */
//#define WIN_W 1600		// largeur de la fenetre
//#define WIN_H 1000		// hauteur de la fenetre
//#define WIN_S_H 1025	// hauteur de size de fenetre

/* Menu */
#define DEFILEMENT 2 	// Incrément de décalage du menu
...
#define BANDEAU_H 200	// hauteur du bandeau gris pour les boutons
#define VIE_W 200
#define VIE_H 10
...
#define U_PRIX_P -4		// prix que coûte un paysan à créer
#define U_PRIX_S -8		// prix que coûte un soldat à créer
#define U_PRIX_C -12	// prix que coûte un cyborg à créer
